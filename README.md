...
curl -LsSf https://github.com/fllesser/nbr/releases/download/v0.1.1/nbr-Linux-musl-x86_64.tar.gz | tar -xzf -
...
# MacOS
# Download the latest release from GitHub
curl -LsSf https://github.com/fllesser/nbr/releases/download/v0.1.1/nbr-macOS-arm64.tar.gz | tar -xzf -
